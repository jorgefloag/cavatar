        ...
        <div className="mx-auto grid max-w-2xl gap-8 md:grid-cols-2">
          {features.map((feature) => (
            <Link key={feature.title} href={feature.href} className="group">
              <div className="flex h-full flex-col items-center border-2 border-border bg-card p-8 text-center transition-all duration-200 hover:border-primary">
                ...
                <h3 className="mb-2 font-label text-2xl uppercase tracking-tight text-foreground">
                  {feature.title}
                </h3>
                <p className="mb-6 flex-1 text-muted-foreground">
                  {feature.description}
                </p>
                <div className="flex items-center gap-2 font-label text-sm uppercase text-primary transition-all group-hover:gap-3">
                  <span>Ir</span>
